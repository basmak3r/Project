...
namespace EngineersMatrimony.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RegID,MID,PName,Email,DOB,Phone,Education,Gender,District,Height,Weight,Occupation,MStatus,Photo1,Photo2,Photo3,FamilyType,AnnualIncome")] Profile profile)
        {
